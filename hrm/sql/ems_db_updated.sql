...
-- 1. Quản lý kỳ chốt công (Dành cho HRM Lock/Unlock)
...
-- 2. Phiếu lương thực tế (Kết quả của Payroll Engine mà HRM sẽ duyệt)
...
-- 3. Cập nhật bảng contracts để HRM phê duyệt
